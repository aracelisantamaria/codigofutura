// src/errors.rs
// Custom errors del contrato
use soroban_sdk::contracterror; // Usar contracterror en lugar de panic! permite al contrato fallar gracefully 
                                // y devolver códigos de error descriptivos.
